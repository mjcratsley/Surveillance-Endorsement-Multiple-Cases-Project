...
$$\text{Endorsement}_{i(j,k)} = \gamma_{00} + (\gamma_{10}) \text{SOA}_{k}+(\gamma_{20}) \text{SOA}_{j} +u_{0j} + v_{0k} + e_{ijk}$$

Final Model Equation:

$$\text{Endorsement}_{i(j,k)} = \gamma_{00} + (\gamma_{10} + u_{1j}) \text{SOA}_{k}+(\gamma_{20} + v_{2k}) \text{SOA}_{j} +u_{0j} + v_{0k} + e_{ijk}$$
## Building the Model
